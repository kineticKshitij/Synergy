        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 px-4 py-12 relative overflow-hidden">
            ...
            <div className="max-w-md w-full relative z-10">
                ...
                <div className="text-center mb-8 animate-slideInDown">
                    ...
                    <h1 className="text-4xl font-bold text-white mb-2 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-100">
                        SynergyOS
                    </h1>
                ...
                {/* Login Card */}
                <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20 animate-slideInUp">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full px-12 py-4 bg-white/10 backdrop-blur-sm border-2 border-white/20 rounded-xl text-white placeholder-blue-200/50 focus:border-blue-400 focus:ring-4 focus:ring-blue-500/30 transition-all"
                        ...
                        {use2FA && otpSent && (
                            <div className="animate-slideInDown">
                                <input
                                    ...
                                    className="w-full px-4 py-4 bg-white/10 backdrop-blur-sm border-2 border-white/20 rounded-xl text-white placeholder-blue-200/50 focus:border-blue-400 focus:ring-4 focus:ring-blue-500/30 transition-all text-center text-2xl tracking-[0.5em] font-bold"
                                    placeholder="000000"
                                    maxLength={6}
                                    required
                                    disabled={isLoading}
                                />
                                <p className="mt-2 text-xs text-blue-200 text-center flex items-center justify-center gap-2">
