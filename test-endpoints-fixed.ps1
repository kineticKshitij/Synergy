...
Test-Endpoint -Method POST -Url "$apiUrl/auth/register/" `
...
# Get Profile
$profileResult = Test-Endpoint -Method GET -Url "$apiUrl/auth/profile/" `
    -Description "Get User Profile" `
    -Headers $headers

# Get Dashboard Stats
Test-Endpoint -Method GET -Url "$apiUrl/auth/dashboard/" `
...
# Get Security Events
Test-Endpoint -Method GET -Url "$apiUrl/auth/security-events/" `
    -Description "Get Security Events" `
    -Headers $headers

# Get Active Sessions
Test-Endpoint -Method GET -Url "$apiUrl/auth/active-sessions/" `
